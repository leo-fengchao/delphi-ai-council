...
const gemini: SiteAdapter = {
  ...
  input: { method: 'paste', submit: 'enterKey' },
  // 深度思考三步（2026-06-03 实测）：开开关菜单 → 选项 → 二级菜单选项。
  // ⚠️ 含 Angular 动态标记 .ng-star-inserted 与深层 gem-menu 链，较脆；失效时由用户重新校准。
  thinkingActivation: [
    'button.input-area-switch > span.mat-mdc-button-touch-target',
